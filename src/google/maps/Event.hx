...
extern class Event {
	...
	static function addListener(target:Dynamic, event:String, handler:Function):Void;
	static function addListenerOnce(target:Dynamic, event:String, handler:Function):Void;
